# Generated by Powerlevel10k configuration wizard on 2024-03-13 at 18:36 WITA.
...
() {
  ...
  # If set to `0`, directory will always be shortened to its minimum length. Default 80
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%5F'  # green foreground defaut 2F -> Changed to Purple 5F
    ...
    #   local work_dir_regex="${VCS_STATUS_WORKDIR//*\//}"
    #   res+="${untracked}${(g::)work_dir_regex} "
    # fi
